...
<div>
    ...
    <div id="cart-sum" class="content-sec">
        <div class="container"> <!-- A. .DIV="container" STARTS HERE AT A. -->
...
$dbh->exec("update	$cartitems set qty = '$qtytoupdate' where cartitems = '$prodid' and sessid = '$sessid'");
 ...
 ?>
            <div class="row">
                ...
                <form action = "<?= $root;?>viewcart.php" method = "post"> <!-- B. FORM STARTS HERE AT B. -->
                ...
                <div class="col-md-2 mb-3 mt-1 text-md-center">
                    <a href="<?= $root;?>viewcart.php?remove=<?= $cartitemnum;?>" id="remove" class="link"> Remove</a>
                </div>
            ...
            <div class="row">
                ...
                </form> <!-- B. FORM ENDS AT B. - throws error because product html does not show up in html validator-->
         
            </div><!-- /.row -->

            <hr>
<!-- TOTAL CALCULATIONS and START OF FORM TO CONNECT TO PAYPAL-->
<form action= "https://www.sandbox.paypal.com/us/cgi-bin/webscr" method="post"  name="_xclick" id="needs-validation" novalidate> <!-- C. FORM STARTS HERE AT C. -->
...
$cartcontent .= "$name x $qty at $$price per unit = $$total<br/>"; 
$subtotal += $total;
$total_ship = $subtotal + 10;
}
echo '<input type = "hidden" name = "shipping_1" value = "10.00"/>';
...
<br>
            ...
            <div class="row">
                    <div class="col-4">
                        <span class="sm-brn-cap">Shipping (Flat Rate): </span>
                    </div>
                    <div class="col-8 text-right">
                        <p>$10.00</p>
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="col-10 text-right">
                        <p class="price">$<?php echo $total_ship; ?></p>
                    </div>
            </div><!-- /.row -->
            
        </div> <!-- A. .DIV="container" ENDS HERE AT A. -->
    </div><!-- /#cart-sum -->
